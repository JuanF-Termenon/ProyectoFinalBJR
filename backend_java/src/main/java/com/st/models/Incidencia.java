...
public class Incidencia {
    ...
    public Timestamp getFechaInicioAtencion() { return fechaInicioAtencion; }
    public void setFechaInicioAtencion(Timestamp fechaInicioAtencion) { this.fechaInicioAtencion = fechaInicioAtencion; }
    ...
    public String getNombreReportadoPor() { return nombreReportadoPor; }
